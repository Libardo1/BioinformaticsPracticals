...
# sphinx-quickstart on Sat Jan 09 18:21:28 2010.
#
...
project = u'Systems Biology Practicals'
...
latex_documents = [
  ('index', 'SystemsBiology.tex', u'Systems Biology Practicals',
...
# (Noel) The following is all from rst2pdf
